...
namespace O3DWB
{
    ...
    public class ObjectPlacementInspectorGUI : InspectorGUI
    {
        ...
        public override void Initialize()
        {
            ...
            ObjectGroupDatabaseView objectGroupDatabaseView = Octave3DWorldBuilder.Instance.PlacementObjectGroupDatabase.View;
        ...
        public override void Render()
        {
            ...
            Octave3DWorldBuilder.Instance.PlacementObjectGroupDatabase.View.Render();
