...
namespace O3DWB
{
    public static class InspectorGUIIdentifiers
    {
        ...
        private static void InitializeIdentifiersArray()
        {
            ...
            _identifiers[(int)InspectorGUIIdentifier.ScenePreparation] = InspectorGUIIdentifier.ScenePreparation;
        }
        ...
        private static void InitializeSceneRenderPathTypesArray()
        {
            ...
            _sceneRenderPathTypes[(int)InspectorGUIIdentifier.ScenePreparation] = SceneRenderPathType.ScenePreparation;
        }
        #endregion
    }
}
