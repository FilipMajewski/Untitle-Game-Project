...
namespace O3DWB
{
    ...
    public abstract class Octave3DEditorWindow : EditorWindow
    {
        ...
        private void Update()
        {
            ...
            // Whenever we find that no Octave3D instance exists in the scene, we will destroy the window.
            // This relieves us from having to take care of destroying the windows in 'OnDestroy' methods
            // which is incredibly messy because 'OnDestroy' is called when switching between play and edit
            // mode and all sorts of complications can arise.
            if (Octave3DWorldBuilder.Instance == null) Close();
        }
        #endregion
    }
}
