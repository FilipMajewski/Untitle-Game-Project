...
namespace O3DWB
{
    ...
    public class ObjectSelectionPrefabCreationSettingsView : SettingsView
    {
        ...
        {
            if(GUILayout.Button(GetContentForCreatePrefabButton(), GUILayout.Width(EditorGUILayoutEx.PreferedActionButtonWidth)))
            {
                PrefabFactory.CreateFromSelectedObjects();
            }
        }
