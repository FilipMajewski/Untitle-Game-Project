...
namespace O3DWB
{
    ...
    public class ObjectEraserSettingsView : SettingsView
    {
        ...
        {
            Octave3DWorldBuilder.Instance.ShowGUIHint("Usually, you will want to allow Undo/Redo for object erasing. However, please keep in mind that this can " + 
            ...
            {
                Octave3DWorldBuilder.Instance.ShowGUIHint("This erase mode is ideal for performing quick clean-ups in your game level. Please keep in mind that " + 
            ...
            {
                Octave3DWorldBuilder.Instance.ShowGUIHint("The 3D brush is great for erasing large amount of objects quickly and efficiently. One thing to keep in mind is that " + 
