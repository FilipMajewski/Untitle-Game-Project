...
namespace O3DWB
{
    ...
    public class ObjectGroupDatabaseView : EntityView
    {
        ...
        private ObjectGroupDatabaseViewData ViewData
        {
            get
            {
                if (_viewData == null) _viewData = Octave3DWorldBuilder.Instance.CreateScriptableObject<ObjectGroupDatabaseViewData>();
                return _viewData;
            }
        }
        #endregion
        ...
        private void RenderMakeActiveGroupStaticButton()
        {
            ...
            {
                List<GameObject> allObjectsInActivegroup = _database.ActiveGroup.GroupParent.GetAllChildrenIncludingSelf();
