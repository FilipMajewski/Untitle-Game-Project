...
namespace O3DWB
{
    ...
    public class PrefabTagSelectionView : EntityView
    {
        ...
        private PrefabTagSelectionViewData ViewData
        {
            get
            {
                if (_viewData == null) _viewData = Octave3DWorldBuilder.Instance.CreateScriptableObject<PrefabTagSelectionViewData>();
                return _viewData;
            }
        }
        #endregion
        ...
        {
            base.Dispose();
            if (_viewData != null) UndoEx.DestroyObjectImmediate(_viewData);
        }
        #endregion
        ...
        {
            ViewData.PrefabTagScrollPosition = EditorGUILayout.BeginScrollView(ViewData.PrefabTagScrollPosition, GetStyleForPrefabTagSelectionScrollView(), GUILayout.Height(PrefabTagSelectionViewData.PrefabTagScrollViewHeight));
            RenderSelectionToggleControlsForFilteredTags();
            EditorGUILayout.EndScrollView();
        }

        private GUIStyle GetStyleForPrefabTagSelectionScrollView()
        {
        ...
        private void RenderSelectionToggleControlsForFilteredTags()
        {
            ...
            {
                RenderTagSelectionEntry(prefabTag);
            }
        }

        private void RenderTagSelectionEntry(PrefabTag prefabTag)
        {
