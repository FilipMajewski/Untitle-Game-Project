...
namespace O3DWB
{
    ...
    public class PrefabCategoryPrefabScrollViewData : ScriptableObject
    {
        ...
        [SerializeField]
        private Color _activePrefabHighlightColor = new Color(0.639f, 0.909f, 1.0f, 1.0f);
        [SerializeField]
        private bool _showPrefabNames = false;

        [SerializeField]
        private bool _isLookAndFeelViewVisible = false;
        #endregion
        ...
        public Color ActivePrefabHighlightColor { get { return _activePrefabHighlightColor; } set { _activePrefabHighlightColor = value; } }
        public bool ShowPrefabNames { get { return _showPrefabNames; } set { _showPrefabNames = value; } }
        public bool IsLookAndFeelViewVisible { get { return _isLookAndFeelViewVisible; } set { _isLookAndFeelViewVisible = value; } }
        #endregion
    }
}
#endif