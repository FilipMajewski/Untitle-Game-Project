...
namespace O3DWB
{
    ...
    public class AxisRotationRandomizationModeSettings : ScriptableObject
    {
        ...
        public RandomRotationStepAxisRandomizationSettings RandomRotationStepAxisRandomizationSettings
        {
            get
            {
                if (_randomRotationStepAxisRandomizationSettings == null) _randomRotationStepAxisRandomizationSettings = Octave3DWorldBuilder.Instance.CreateScriptableObject<RandomRotationStepAxisRandomizationSettings>();
        ...
        public RandomRotationValueAxisRandomizationSettings RandomRotationValueAxisRandomizationSettings
        {
            get
            {
                if (_randomRotationValueAxisRandomizationSettings == null) _randomRotationValueAxisRandomizationSettings = Octave3DWorldBuilder.Instance.CreateScriptableObject<RandomRotationValueAxisRandomizationSettings>();
