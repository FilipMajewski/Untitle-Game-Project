...
namespace O3DWB
{
    ...
    public class AxisRotationRandomizationSettings : ScriptableObject
    {
        ...
        public AxisRotationRandomizationModeSettings RandomizationModeSettings
        {
            get
            {
                if (_randomizationModeSettings == null) _randomizationModeSettings = Octave3DWorldBuilder.Instance.CreateScriptableObject<AxisRotationRandomizationModeSettings>();
