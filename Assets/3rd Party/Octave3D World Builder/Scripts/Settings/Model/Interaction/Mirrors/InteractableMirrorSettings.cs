...
namespace O3DWB
{
    ...
    public class InteractableMirrorSettings : ScriptableObject
    {
        ...
        public ObjectMouseMoveAlongDirectionSettings MouseOffsetFromHoverSurfaceSettings
        {
            get
            {
                if (_mouseOffsetFromHoverSurfaceSettings == null) _mouseOffsetFromHoverSurfaceSettings = Octave3DWorldBuilder.Instance.CreateScriptableObject<ObjectMouseMoveAlongDirectionSettings>();
