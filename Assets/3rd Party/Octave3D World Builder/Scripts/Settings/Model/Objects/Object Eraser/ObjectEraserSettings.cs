...
namespace O3DWB
{
    ...
    public class ObjectEraserSettings : ScriptableObject
    {
        ...
        public Object2DMassEraseSettings Mass2DEraseSettings
        {
            get
            {
                if (_mass2DEraseSettings == null) _mass2DEraseSettings = Octave3DWorldBuilder.Instance.CreateScriptableObject<Object2DMassEraseSettings>();
        ...
        public Object3DMassEraseSettings Mass3DEraseSettings
        {
            get
            {
                if (_mass3DEraseSettings == null) _mass3DEraseSettings = Octave3DWorldBuilder.Instance.CreateScriptableObject<Object3DMassEraseSettings>();
