...
namespace O3DWB
{
    ...
    public class ObjectScaleRandomizationSettings : ScriptableObject
    {
        ...
        public ObjectUniformScaleRandomizationSettings UniformScaleRandomizationSettings
        {
            get
            {
                if (_uniformScaleRandomizationSettings == null) _uniformScaleRandomizationSettings = Octave3DWorldBuilder.Instance.CreateScriptableObject<ObjectUniformScaleRandomizationSettings>();
