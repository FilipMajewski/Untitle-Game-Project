...
namespace O3DWB
{
    ...
    public class ProjectedBoxFacePivotPointsRenderSettings : ScriptableObject
    {
        ...
        { 
            get 
            {
                if (_activePivotPointRenderSettings == null) _activePivotPointRenderSettings = Octave3DWorldBuilder.Instance.CreateScriptableObject<SingleObjectPivotPointRenderSettings>();
        ...
        { 
            get 
            {
                if (_inactivePivotPointRenderSettings == null) _inactivePivotPointRenderSettings = Octave3DWorldBuilder.Instance.CreateScriptableObject<SingleObjectPivotPointRenderSettings>();
