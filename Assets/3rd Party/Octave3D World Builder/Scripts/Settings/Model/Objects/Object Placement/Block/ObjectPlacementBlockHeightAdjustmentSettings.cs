...
namespace O3DWB
{
    ...
    public class ObjectPlacementBlockHeightAdjustmentSettings : ScriptableObject
    {
        ...
        public ObjectPlacementBlockManualHeightAdjustmentSettings ManualHeightAdjustmentSettings
        {
            get
            {
                if (_manualHeightAdjustmentSettings == null) _manualHeightAdjustmentSettings = Octave3DWorldBuilder.Instance.CreateScriptableObject<ObjectPlacementBlockManualHeightAdjustmentSettings>();
        ...
        public ObjectPlacementBlockAutomaticRandomHeightAdjustmentSettings AutomaticRandomHeightAdjustmentSettings
        {
            get
            {
                if (_automaticRandomHeightAdjustmentSettings == null) _automaticRandomHeightAdjustmentSettings = Octave3DWorldBuilder.Instance.CreateScriptableObject<ObjectPlacementBlockAutomaticRandomHeightAdjustmentSettings>();
