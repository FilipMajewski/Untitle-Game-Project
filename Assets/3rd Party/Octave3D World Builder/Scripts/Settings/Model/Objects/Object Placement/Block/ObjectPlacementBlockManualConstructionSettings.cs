...
namespace O3DWB
{
    ...
    public class ObjectPlacementBlockManualConstructionSettings : ScriptableObject
    {
        ...
        public ObjectPlacementBlockPaddingSettings PaddingSettings
        {
            get
            {
                if (_paddingSettings == null) _paddingSettings = Octave3DWorldBuilder.Instance.CreateScriptableObject<ObjectPlacementBlockPaddingSettings>();
        ...
        public ObjectRotationRandomizationSettings ObjectRotationRandomizationSettings
        {
            get
            {
                if (_objectRotationRandomizationSettings == null) _objectRotationRandomizationSettings = Octave3DWorldBuilder.Instance.CreateScriptableObject<ObjectRotationRandomizationSettings>();
        ...
        public ObjectPlacementBlockHeightAdjustmentSettings HeightAdjustmentSettings
        {
            get
            {
                if (_heightAdjustmentSettings == null) _heightAdjustmentSettings = Octave3DWorldBuilder.Instance.CreateScriptableObject<ObjectPlacementBlockHeightAdjustmentSettings>();
        ...
        public ObjectPlacementBlockSubdivisionSettings SubdivisionSettings
        {
            get
            {
                if (_subdivisionSettings == null) _subdivisionSettings = Octave3DWorldBuilder.Instance.CreateScriptableObject<ObjectPlacementBlockSubdivisionSettings>();
