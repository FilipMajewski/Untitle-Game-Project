...
namespace O3DWB
{
    ...
    public class ObjectPlacementPathTileConnectionSettings : ScriptableObject
    {
        ...
        private void InitializePathTileConnectionTypeSettingsArray()
        {
            ...
            {
                ObjectPlacementPathTileConnectionTypeSettings tileConnectionTypeSettings = Octave3DWorldBuilder.Instance.CreateScriptableObject<ObjectPlacementPathTileConnectionTypeSettings>();
