...
namespace O3DWB
{
    ...
    public class ObjectPlacementGuideSettings : ScriptableObject
    {
        ...
        public ObjectMouseMoveAlongDirectionSettings MouseOffsetFromPlacementSurfaceSettings
        {
            get
            {
                if (_mouseOffsetFromPlacementSurfaceSettings == null) _mouseOffsetFromPlacementSurfaceSettings = Octave3DWorldBuilder.Instance.CreateScriptableObject<ObjectMouseMoveAlongDirectionSettings>();
        ...
        public ObjectKeyboardRotationSettings KeyboardRotationSettings
        {
            get
            {
                if (_keyboardRotationSettings == null) _keyboardRotationSettings = Octave3DWorldBuilder.Instance.CreateScriptableObject<ObjectKeyboardRotationSettings>();
        ...
        public ObjectMouseRotationSettings MouseRotationSettings
        {
            get
            {
                if (_mouseRotationSettings == null) _mouseRotationSettings = Octave3DWorldBuilder.Instance.CreateScriptableObject<ObjectMouseRotationSettings>();
        ...
        public ObjectMouseUniformScaleSettings MouseUniformScaleSettings
        {
            get
            {
                if (_mouseUniformScaleSettings == null) _mouseUniformScaleSettings = Octave3DWorldBuilder.Instance.CreateScriptableObject<ObjectMouseUniformScaleSettings>();
