...
namespace O3DWB
{
    ...
    public class ObjectPlacementPathRenderSettings : ScriptableObject
    {
        ...
        public ObjectPlacementPathManualConstructionRenderSettings ManualConstructionRenderSettings
        {
            get
            {
                if (_manualConstructionRenderSettings == null) _manualConstructionRenderSettings = Octave3DWorldBuilder.Instance.CreateScriptableObject<ObjectPlacementPathManualConstructionRenderSettings>();
