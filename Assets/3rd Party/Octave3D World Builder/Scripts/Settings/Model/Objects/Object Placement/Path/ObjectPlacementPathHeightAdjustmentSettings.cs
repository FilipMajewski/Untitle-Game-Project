...
namespace O3DWB
{
    ...
    public class ObjectPlacementPathHeightAdjustmentSettings : ScriptableObject
    {
        ...
        public ObjectPlacementPathManualHeightAdjustmentSettings ManualHeightAdjustmentSettings
        {
            get
            {
                if (_manualHeightAdjustmentSettings == null) _manualHeightAdjustmentSettings = Octave3DWorldBuilder.Instance.CreateScriptableObject<ObjectPlacementPathManualHeightAdjustmentSettings>();
        ...
        public ObjectPlacementPathAutomaticRandomHeightAdjustmentSettings AutomaticRandomHeightAdjustmentSettings
        {
            get
            {
                if (_automaticRandomHeightAdjustmentSettings == null) _automaticRandomHeightAdjustmentSettings = Octave3DWorldBuilder.Instance.CreateScriptableObject<ObjectPlacementPathAutomaticRandomHeightAdjustmentSettings>();
        ...
        public ObjectPlacementPathAutomaticPatternHeightAdjustmentSettings AutomaticPatternHeightAdjustmentSettings
        {
            get
            {
                if (_automaticPatternHeightAdjustmentSettings == null) _automaticPatternHeightAdjustmentSettings = Octave3DWorldBuilder.Instance.CreateScriptableObject<ObjectPlacementPathAutomaticPatternHeightAdjustmentSettings>();
