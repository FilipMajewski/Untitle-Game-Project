...
namespace O3DWB
{
    ...
    public class ObjectPlacementPathManualConstructionSettings : ScriptableObject
    {
        ...
        public ObjectPlacementPathPaddingSettings PaddingSettings
        {
            get
            {
                if (_paddingSettings == null) _paddingSettings = Octave3DWorldBuilder.Instance.CreateScriptableObject<ObjectPlacementPathPaddingSettings>();
        ...
        public ObjectPlacementPathHeightAdjustmentSettings HeightAdjustmentSettings
        {
            get
            {
                if (_heightAdjustmentSettings == null) _heightAdjustmentSettings = Octave3DWorldBuilder.Instance.CreateScriptableObject<ObjectPlacementPathHeightAdjustmentSettings>();
        ...
        public ObjectPlacementPathBorderSettings BorderSettings
        {
            get
            {
                if (_borderSettings == null) _borderSettings = Octave3DWorldBuilder.Instance.CreateScriptableObject<ObjectPlacementPathBorderSettings>();
