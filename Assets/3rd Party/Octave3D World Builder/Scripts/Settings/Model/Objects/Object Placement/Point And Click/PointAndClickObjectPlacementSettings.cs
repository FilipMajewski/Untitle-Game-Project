...
namespace O3DWB
{
    ...
    public class PointAndClickObjectPlacementSettings : ScriptableObject
    {
        ...
        public AxisAlignmentSettings PlacementGuideSurfaceAlignmentSettings
        {
            get
            {
                if (_placementGuideSurfaceAlignmentSettings == null) _placementGuideSurfaceAlignmentSettings = Octave3DWorldBuilder.Instance.CreateScriptableObject<AxisAlignmentSettings>();
        ...
        public ObjectRotationRandomizationSettings PlacementGuideRotationRandomizationSettings
        {
            get
            {
                if (_placementGuideRotationRandomizationSettings == null) _placementGuideRotationRandomizationSettings = Octave3DWorldBuilder.Instance.CreateScriptableObject<ObjectRotationRandomizationSettings>();
        ...
        public ObjectScaleRandomizationSettings PlacementGuideScaleRandomizationSettings
        {
            get
            {
                if (_placementGuideScaleRandomizationSettings == null) _placementGuideScaleRandomizationSettings = Octave3DWorldBuilder.Instance.CreateScriptableObject<ObjectScaleRandomizationSettings>();
