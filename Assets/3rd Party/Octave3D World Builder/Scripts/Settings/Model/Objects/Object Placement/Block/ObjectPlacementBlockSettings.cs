...
namespace O3DWB
{
    ...
    public class ObjectPlacementBlockSettings : ScriptableObject
    {
        ...
        public ObjectPlacementBlockManualConstructionSettings ManualConstructionSettings
        {
            get
            {
                if (_manualConstructionSettings == null) _manualConstructionSettings = Octave3DWorldBuilder.Instance.CreateScriptableObject<ObjectPlacementBlockManualConstructionSettings>();
