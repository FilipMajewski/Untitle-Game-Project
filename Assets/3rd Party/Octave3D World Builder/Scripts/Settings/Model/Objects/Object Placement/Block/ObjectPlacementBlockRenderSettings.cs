...
namespace O3DWB
{
    ...
    public class ObjectPlacementBlockRenderSettings : ScriptableObject
    {
        ...
        public ObjectPlacementBlockManualConstructionRenderSettings ManualConstructionRenderSettings
        {
            get
            {
                if (_manualConstructionRenderSettings == null) _manualConstructionRenderSettings = Octave3DWorldBuilder.Instance.CreateScriptableObject<ObjectPlacementBlockManualConstructionRenderSettings>();
