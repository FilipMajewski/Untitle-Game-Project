...
namespace O3DWB
{
    ...
    public class ObjectPlacementPathSettings : ScriptableObject
    {
        ...
        public ObjectPlacementPathManualConstructionSettings ManualConstructionSettings
        {
            get
            {
                if (_manualConstructionSettings == null) _manualConstructionSettings = Octave3DWorldBuilder.Instance.CreateScriptableObject<ObjectPlacementPathManualConstructionSettings>();
        ...
        public ObjectPlacementPathTileConnectionSettings TileConnectionSettings
        {
            get
            {
                if (_tileConnectionSettings == null) _tileConnectionSettings = Octave3DWorldBuilder.Instance.CreateScriptableObject<ObjectPlacementPathTileConnectionSettings>();
