...
namespace O3DWB
{
    ...
    public class DecorPaintObjectPlacementSettings : ScriptableObject
    {
        ...
        public SingleDecorPaintModeObjectPlacementSettings SingleDecorPaintModeSettings
        {
            get
            {
                if (_singleDecorPaintModeSettings == null) _singleDecorPaintModeSettings = Octave3DWorldBuilder.Instance.CreateScriptableObject<SingleDecorPaintModeObjectPlacementSettings>();
        ...
        public BrushDecorPaintModeObjectPlacementSettings BrushDecorPaintModeSettings
        {
            get
            {
                if (_brushDecorPaintModeSettings == null) _brushDecorPaintModeSettings = Octave3DWorldBuilder.Instance.CreateScriptableObject<BrushDecorPaintModeObjectPlacementSettings>();
