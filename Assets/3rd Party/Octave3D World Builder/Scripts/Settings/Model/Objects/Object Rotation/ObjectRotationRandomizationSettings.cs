...
namespace O3DWB
{
    ...
    public class ObjectRotationRandomizationSettings : ScriptableObject
    {
        ...
        public CustomAxisRotationRandomizationSettings CustomAxisRandomizationSettings
        {
            get
            {
                if (_customAxisRandomizationSettings == null) _customAxisRandomizationSettings = Octave3DWorldBuilder.Instance.CreateScriptableObject<CustomAxisRotationRandomizationSettings>();
        ...
        public AxisRotationRandomizationSettings XAxisRandomizationSettings
        {
            get
            {
                ...
                {
                    _xAxisRandomizationSettings = Octave3DWorldBuilder.Instance.CreateScriptableObject<AxisRotationRandomizationSettings>();
        ...
        public AxisRotationRandomizationSettings YAxisRandomizationSettings
        {
            get
            {
                ...
                {
                    _yAxisRandomizationSettings = Octave3DWorldBuilder.Instance.CreateScriptableObject<AxisRotationRandomizationSettings>();
        ...
        public AxisRotationRandomizationSettings ZAxisRandomizationSettings
        {
            get
            {
                ...
                {
                    _zAxisRandomizationSettings = Octave3DWorldBuilder.Instance.CreateScriptableObject<AxisRotationRandomizationSettings>();
