    ...
    public class ObjectKeyboardRotationSettings : ScriptableObject
    {
        ...
        public AxisKeyboardRotationSettings XAxisRotationSettings
        {
            get
            {
                ...
                {
                    _xAxisRotationSettings = Octave3DWorldBuilder.Instance.CreateScriptableObject<AxisKeyboardRotationSettings>();
        ...
        public AxisKeyboardRotationSettings YAxisRotationSettings
        {
            get
            {
                ...
                {
                    _yAxisRotationSettings = Octave3DWorldBuilder.Instance.CreateScriptableObject<AxisKeyboardRotationSettings>();
        ...
        public AxisKeyboardRotationSettings ZAxisRotationSettings
        {
            get
            {
                ...
                {
                    _zAxisRotationSettings = Octave3DWorldBuilder.Instance.CreateScriptableObject<AxisKeyboardRotationSettings>();
        ...
        public CustomAxisKeyboardRotationSettings CustomAxisRotationSettings
        {
            get
            {
                if (_customAxisRotationSettings == null) _customAxisRotationSettings = Octave3DWorldBuilder.Instance.CreateScriptableObject<CustomAxisKeyboardRotationSettings>();
