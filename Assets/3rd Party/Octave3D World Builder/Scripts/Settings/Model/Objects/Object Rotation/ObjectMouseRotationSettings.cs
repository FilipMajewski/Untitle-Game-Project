    ...
    public class ObjectMouseRotationSettings : ScriptableObject
    {
        ...
        public AxisMouseRotationSettings XAxisRotationSettings
        {
            get
            {
                ...
                {
                    _xAxisRotationSettings = Octave3DWorldBuilder.Instance.CreateScriptableObject<AxisMouseRotationSettings>();
        ...
        public AxisMouseRotationSettings YAxisRotationSettings
        {
            get
            {
                ...
                {
                    _yAxisRotationSettings = Octave3DWorldBuilder.Instance.CreateScriptableObject<AxisMouseRotationSettings>();
        ...
        public AxisMouseRotationSettings ZAxisRotationSettings
        {
            get
            {
                ...
                {
                    _zAxisRotationSettings = Octave3DWorldBuilder.Instance.CreateScriptableObject<AxisMouseRotationSettings>();
        ...
        public CustomAxisMouseRotationSettings CustomAxisRotationSettings
        {
            get
            {
                if (_customAxisRotationSettings == null) _customAxisRotationSettings = Octave3DWorldBuilder.Instance.CreateScriptableObject<CustomAxisMouseRotationSettings>();
