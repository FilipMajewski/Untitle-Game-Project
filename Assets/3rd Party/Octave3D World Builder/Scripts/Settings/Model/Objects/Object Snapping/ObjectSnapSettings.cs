...
namespace O3DWB
{
    ...
    public class ObjectSnapSettings : ScriptableObject
    {
        ...
        { 
            get { return ObjectSnapping.Get().XZSnapGrid.GetOriginPosition().y; }
            set 
            {
        ...
        public ObjectColliderSnapSurfaceGridSettings ObjectColliderSnapSurfaceGridSettings
        {
            get
            {
                if (_objectColliderSnapSurfaceGridSettings == null) _objectColliderSnapSurfaceGridSettings = Octave3DWorldBuilder.Instance.CreateScriptableObject<ObjectColliderSnapSurfaceGridSettings>();
