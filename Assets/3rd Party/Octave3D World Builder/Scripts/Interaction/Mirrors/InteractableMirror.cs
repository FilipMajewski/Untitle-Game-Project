...
namespace O3DWB
{
    ...
    public class InteractableMirror : ScriptableObject
    {
        ...
        public InteractableMirrorSettings Settings
        {
            get
            {
                if (_settings == null) _settings = Octave3DWorldBuilder.Instance.CreateScriptableObject<InteractableMirrorSettings>();
                return _settings;
            }
        }
        public InteractableMirrorRenderSettings RenderSettings
        {
            get
            {
                if (_renderSettings == null) _renderSettings = Octave3DWorldBuilder.Instance.CreateScriptableObject<InteractableMirrorRenderSettings>();
        ...
        public GameObject MirrorGameObjectHierarchy(GameObject hierarchyRoot, Prefab sourcePrefab)
        {
            ...
            if (sourcePrefab != null) mirroredHierarchyRoot = ObjectInstantiation.InstantiateObjectHierarchyFromPrefab(sourcePrefab, hierarchyRootTransform.position, hierarchyRootTransform.rotation, hierarchyRootTransform.lossyScale);
            else mirroredHierarchyRoot = hierarchyRoot.Clone();
        ...
        {
            if (_isInteractionSessionActive) Octave3DWorldBuilder.Instance.Inspector.EditorWindow.Repaint();
