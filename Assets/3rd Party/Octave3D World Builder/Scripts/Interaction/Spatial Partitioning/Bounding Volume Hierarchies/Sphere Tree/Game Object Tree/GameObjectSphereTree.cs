...
namespace O3DWB
{
    ...
    public class GameObjectSphereTree : ISerializationCallbackReceiver
    {
        ...
        /// </param>
        public List<GameObject> OverlapSphere(Sphere sphere, ObjectOverlapPrecision objectOverlapPrecision = ObjectOverlapPrecision.ObjectBox)
        {
        ...
        public void HandleTransformChangesForAllRegisteredObjects()
        {
            ...
            if (Octave3DWorldBuilder.Instance != null && Selection.Contains(Octave3DWorldBuilder.Instance.gameObject))
            {
        ...
        private bool CanGameObjectBeRegisteredWithTree(GameObject gameObject)
        {
            ...
            if (!Octave3DWorldBuilder.Instance.IsWorkingObject(gameObject)) return false;
            if (Octave3DWorldBuilder.Instance.IsPivotWorkingObject(gameObject)) return false;
