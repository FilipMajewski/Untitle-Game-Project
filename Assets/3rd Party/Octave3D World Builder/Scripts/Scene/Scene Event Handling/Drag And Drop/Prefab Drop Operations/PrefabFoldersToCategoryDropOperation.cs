...
namespace O3DWB
{
    public class PrefabFoldersToCategoryDropOperation : IPrefabsDropOperation
    {
        ...
        private void DropPrefabFolders()
        {
            ...
            {
                EditorUtility.DisplayProgressBar("Processing dropped folders", "Please wait...", (float)folderDropDataIndex / prefabFoldersDropDataCollection.Count);
        ...
        private void DropPrefabFolderToCategory(PrefabFolderDropData prefabFolderDropData)
        {
            ...
            else _dropData.DestinationCategory.AddPrefabCollection(prefabFolderDropData.ValidPrefabs);
        }
