...
namespace O3DWB
{
    ...
    public class PrefabsToPathTileConectionDropEventHandler : DragAndDropEventHandler
    {
        ...
        public PrefabsToPathTileConectionButtonDropSettings DropSettings
        {
            get
            {
                if (_dropSettings == null) _dropSettings = Octave3DWorldBuilder.Instance.CreateScriptableObject<PrefabsToPathTileConectionButtonDropSettings>();
        ...
        {
            return Octave3DWorldBuilder.Instance.PrefabsToPathTileConectionDropEventHandler;
        }
        #endregion
