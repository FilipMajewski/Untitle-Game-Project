...
namespace O3DWB
{
    ...
    public class PrefabsToCategoryDropEventHandler : DragAndDropEventHandler
    {
        ...
        public PrefabsToCategoryDropSettings PrefabsDropSettings
        {
            get
            {
                if (_prefabsDropSettings == null) _prefabsDropSettings = Octave3DWorldBuilder.Instance.CreateScriptableObject<PrefabsToCategoryDropSettings>();
        ...
        public PrefabFoldersToCategoryDropSettings PrefabFoldersDropSettings
        {
            get
            {
                if (_prefabFoldersDropSettings == null) _prefabFoldersDropSettings = Octave3DWorldBuilder.Instance.CreateScriptableObject<PrefabFoldersToCategoryDropSettings>();
        ...
        {
            return Octave3DWorldBuilder.Instance.PrefabsToCategoryDropEventHandler;
        }
        #endregion
