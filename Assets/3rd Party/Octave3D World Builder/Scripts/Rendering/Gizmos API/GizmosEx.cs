...
namespace O3DWB
{
    public static class GizmosEx
    {
        ...
        public static void Render2DFilledRectangle(Rect rectangle, Color color)
        {
            ...
            Matrix4x4 transformMatrix = Matrix4x4.TRS(rectangleWorldPosition, cameraTransform.rotation, new Vector3(width, height, 0.001f));
        ...
        {
            if (_xyRectangleMesh == null) _xyRectangleMesh = Octave3DWorldBuilder.Instance.ToolResources.MeshResources.CreateXYRectangleMesh(1.0f, 1.0f, Color.white);
            return _xyRectangleMesh;
        }

        private static Mesh GetCircleMesh()
        {
            if (_xyCircleMesh == null) _xyCircleMesh = Octave3DWorldBuilder.Instance.ToolResources.MeshResources.CreateXYCircleMesh(1.0f, _numberOfCircleMeshSlices, Color.white);
