...
namespace O3DWB
{
    public static class ProjectAssetDatabase
    {
        ...
        public static List<GameObject> LoadAllValidPrefabsInFolder(string folderName, bool includeSubfolders = true)
        {
            ...
            else
            {
                ...
                return GetValidPrefabsWhichExistAmongstAssets(assetPaths);
            }
        }
        ...
        private static List<GameObject> GetValidPrefabsWhichExistAmongstAssets(List<string> assetPaths)
        {
            var validPrefabs = new List<GameObject>();
