...
namespace O3DWB
{
    public static class PrefabFactory
    {
        ...
        {
            Prefab prefab = Octave3DWorldBuilder.Instance.CreateScriptableObject<Prefab>();
        ...
        public static Prefab CreateFromSelectedObjects()
        {
            ...
            Vector3 objectPositionSum = Vector3.zero;
            ...
            {
                objectPositionSum += gameObject.GetWorldOrientedBox().Center;
                ...
                cloneTransform.parent = prefabRootTransform;
            }
            prefabRootTransform.position = objectPositionSum * (1.0f / allSelectedObjects.Count);
