...
namespace O3DWB
{
    ...
    public class PrefabTagAssociations : ScriptableObject, IMessageListener
    {
        ...
        [SerializeField]
        private SerializablePrefabTagHashSet _associatedTags = new SerializablePrefabTagHashSet();
        [SerializeField]
        ...
        public PrefabTagFilter PrefabTagFilter
        {
            get
            {
                if (_prefabTagFilter == null) _prefabTagFilter = Octave3DWorldBuilder.Instance.CreateScriptableObject<PrefabTagFilter>();
        ...
        {
            foreach(PrefabTag prefabTag in _associatedTags.HashSet)
            {
        ...
        {
            _associatedTags.RemoveWhere(item => item.Name == tagName);
        }
        ...
        {
            _associatedTags.RemoveWhere(item => item == null);
        }
        ...
        {
            return (from prefabTag in _associatedTags.HashSet select prefabTag.Name).ToList();
        }
        #endregion
