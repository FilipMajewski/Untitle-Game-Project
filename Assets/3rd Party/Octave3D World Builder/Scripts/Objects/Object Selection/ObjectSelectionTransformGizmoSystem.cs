...
namespace O3DWB
{
    ...
    public class ObjectSelectionTransformGizmoSystem : ScriptableObject
    {
        ...
        public ObjectMoveGizmo ObjectMoveGizmo
        {
            get
            {
                if (_objectMoveGizmo == null) _objectMoveGizmo = Octave3DWorldBuilder.Instance.CreateScriptableObject<ObjectMoveGizmo>();
        ...
        public ObjectRotationGizmo ObjectRotationGizmo
        {
            get
            {
                if (_objectRotationGizmo == null) _objectRotationGizmo = Octave3DWorldBuilder.Instance.CreateScriptableObject<ObjectRotationGizmo>();
        ...
        public ObjectScaleGizmo ObjectScaleGizmo
        {
            get
            {
                if (_objectScaleGizmo == null) _objectScaleGizmo = Octave3DWorldBuilder.Instance.CreateScriptableObject<ObjectScaleGizmo>();
