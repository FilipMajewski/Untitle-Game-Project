...
namespace O3DWB
{
    public class ObjectVertexSnapSession
    {
        ...
        private void Snap()
        {
            ...
            GameObject firstParentChildOfPivot = Octave3DWorldBuilder.Instance.GetFirstParentWhisIsChildOfAPivot(_sourceObject);
            if(firstParentChildOfPivot != null)
            {
                Transform parentTransform = firstParentChildOfPivot.transform;
