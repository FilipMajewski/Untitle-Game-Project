...
namespace O3DWB
{
    ...
    public class DecorPaintObjectPlacementBrushElement : ScriptableObject
    {
        ...
        [SerializeField]
        private float _missChance = 0.0f;
        [SerializeField]
        ...
        public static float MinMissChance { get { return 0.0f; } }
        public static float MaxMissChance { get { return 1.0f; } }
        ...
        public float MissChance { get { return _missChance; } set { _missChance = Mathf.Clamp(value, MinMissChance, MaxMissChance); } }
        ...
        public ObjectScaleRandomizationSettings ScaleRandomizationSettings
        {
            get
            {
                if (_scaleRandomizationSettings == null) _scaleRandomizationSettings = Octave3DWorldBuilder.Instance.CreateScriptableObject<ObjectScaleRandomizationSettings>();
        ...
        public DecorPaintSlopeSettings SlopeSettings
        {
            get
            {
                if (_slopeSettings == null) _slopeSettings = Octave3DWorldBuilder.Instance.CreateScriptableObject<DecorPaintSlopeSettings>();
