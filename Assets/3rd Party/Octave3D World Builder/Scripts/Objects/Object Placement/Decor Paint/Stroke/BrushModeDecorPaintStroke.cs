...
namespace O3DWB
{
    ...
    public class BrushModeDecorPaintStroke : DecorPaintStroke
    {
        ...
        private void PlaceObjects()
        {
            ...
            {
                List<GameObject> placedHierarchyRoots = Octave3DScene.Get().InstantiateObjectHirarchiesFromPlacementDataCollection(_objectPlacementDataCalculator.Calculate(RotationToApplyForStrokeAlignment));
