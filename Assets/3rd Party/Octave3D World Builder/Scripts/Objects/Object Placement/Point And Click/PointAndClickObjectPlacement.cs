...
namespace O3DWB
{
    ...
    public class PointAndClickObjectPlacement
    {
        ...
        private void PlaceObject()
        {
            ...
            GameObject placedHierarchyRoot = Octave3DScene.Get().InstantiateObjectHierarchyPrefab(placementGuide.SourcePrefab, placementGuide.WorldPosition, placementGuide.WorldRotation, placementGuide.WorldScale);
