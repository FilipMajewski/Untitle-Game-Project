...
namespace O3DWB
{
    ...
    public class ObjectPlacementGuide : MonoBehaviour, IMessageListener
    {
        ...
        private static string _name = "Object Placement Guide";
        ...
        private void OnEditorUpdate()
        {
            ...
            {
                if (Octave3DWorldBuilder.Instance == null) UndoEx.DestroyObjectImmediate(gameObject);
                else
                if (!Selection.Contains(Octave3DWorldBuilder.Instance.gameObject)) ObjectPlacement.Get().DestroyPlacementGuide();
            }
        }
        #endregion
        ...
        {
            _instance = ObjectInstantiation.InstantiateObjectPlacementGuide(prefab, _name);
