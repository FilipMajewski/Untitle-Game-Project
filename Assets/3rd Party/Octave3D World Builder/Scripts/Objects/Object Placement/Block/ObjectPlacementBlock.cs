...
namespace O3DWB
{
    ...
    public class ObjectPlacementBlock : IMessageListener
    {
        ...
        public ObjectPlacementBlockSettings Settings
        {
            get
            {
                if (_settings == null) _settings = Octave3DWorldBuilder.Instance.CreateScriptableObject<ObjectPlacementBlockSettings>();
                return _settings;
            }
        }
        ...
        public ObjectPlacementBlockRenderSettings RenderSettings
        {
            get
            {
                if (_renderSettings == null) _renderSettings = Octave3DWorldBuilder.Instance.CreateScriptableObject<ObjectPlacementBlockRenderSettings>();
