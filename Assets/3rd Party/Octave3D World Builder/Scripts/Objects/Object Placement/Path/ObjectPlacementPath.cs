...
namespace O3DWB
{
    ...
    public class ObjectPlacementPath : IMessageListener
    {
        ...
        public ObjectPlacementPathSettings Settings
        {
            get
            {
                if (_settings == null) _settings = Octave3DWorldBuilder.Instance.CreateScriptableObject<ObjectPlacementPathSettings>();
                return _settings;
            }
        }
        public ObjectPlacementPathRenderSettings RenderSettings
        {
            get
            {
                if (_renderSettings == null) _renderSettings = Octave3DWorldBuilder.Instance.CreateScriptableObject<ObjectPlacementPathRenderSettings>();
