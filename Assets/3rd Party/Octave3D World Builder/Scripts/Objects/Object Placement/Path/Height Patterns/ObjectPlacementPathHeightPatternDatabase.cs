...
namespace O3DWB
{
    ...
    public class ObjectPlacementPathHeightPatternDatabase : ScriptableObject
    {
        ...
        public ObjectPlacementPathHeightPatternFilter HeightPatternFilter
        {
            get
            {
                if (_heightPatternFilter == null) _heightPatternFilter = Octave3DWorldBuilder.Instance.CreateScriptableObject<ObjectPlacementPathHeightPatternFilter>();
        ...
        {
            return Octave3DWorldBuilder.Instance.ObjectPlacementPathHeightPatternDatabase;
        }
        #endregion
