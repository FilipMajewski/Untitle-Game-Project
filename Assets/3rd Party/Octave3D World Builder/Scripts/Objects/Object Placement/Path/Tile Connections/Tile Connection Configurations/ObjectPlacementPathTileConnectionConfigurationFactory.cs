...
namespace O3DWB
{
    public static class ObjectPlacementPathTileConnectionConfigurationFactory
    {
        ...
        {
            ObjectPlacementPathTileConnectionConfiguration newConfiguration = Octave3DWorldBuilder.Instance.CreateScriptableObject<ObjectPlacementPathTileConnectionConfiguration>();
