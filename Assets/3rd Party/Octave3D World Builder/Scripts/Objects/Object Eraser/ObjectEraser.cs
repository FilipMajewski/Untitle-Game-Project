...
namespace O3DWB
{
    ...
    public class ObjectEraser : ScriptableObject
    {
        ...
        public ObjectEraserSettings Settings
        {
            get
            {
                if (_settings == null) _settings = Octave3DWorldBuilder.Instance.CreateScriptableObject<ObjectEraserSettings>();
                return _settings;
            }
        }
        ...
        {
            return Octave3DWorldBuilder.Instance.ObjectEraser;
        }
        #endregion
