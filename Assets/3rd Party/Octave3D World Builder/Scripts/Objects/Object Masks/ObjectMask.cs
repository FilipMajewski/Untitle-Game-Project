...
namespace O3DWB
{
    ...
    public class ObjectMask
    {
        ...
        public ObjectLayerObjectMask ObjectLayerObjectMask
        {
            get
            {
                if (_objectLayerObjectMask == null) _objectLayerObjectMask = Octave3DWorldBuilder.Instance.CreateScriptableObject<ObjectLayerObjectMask>();
        ...
        public ObjectCollectionMask ObjectCollectionMask
        {
            get
            {
                if (_objectCollectionMask == null) _objectCollectionMask = Octave3DWorldBuilder.Instance.CreateScriptableObject<ObjectCollectionMask>();
