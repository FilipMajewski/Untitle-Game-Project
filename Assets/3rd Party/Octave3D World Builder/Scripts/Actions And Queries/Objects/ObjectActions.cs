...
namespace O3DWB
{
    public static class ObjectActions
    {
        ...
        public static List<GameObject> ReplaceGameObjectHierarchyCollectionPrefab(List<GameObject> gameObjectCollection, GameObject newPrefab)
        {
            ...
            List<GameObject> parentsWhichAreChildrenOfPivots = Octave3DWorldBuilder.Instance.GetParentsChildrenOfPivots(gameObjectCollection);
            foreach (GameObject gameObject in parentsWhichAreChildrenOfPivots)
            {
        ...
        public static GameObject ReplaceGameObjectHierarchyPrefab(GameObject gameObject, GameObject newPrefab)
        {
            ...
            if (newObject != null)
            {
                ...
                newObjectTransform.parent = Octave3DWorldBuilder.Instance.transform;
                newObject.SetSelectedHierarchyWireframeHidden(true);
